...
| path | wall |
|---|---:|
| plain CPython | 575.8 ± 14.0 ms |
| `ppy run` | 244.8 ± 153.4 ms |
| `ppy build --unsafe` | 154.4 ± 28.9 ms |
| `ppy build --standalone --unsafe` | 73.8 ± 2.5 ms |
| C (`gcc -O3`, `scanf`) | 76.2 ± 17.6 ms |
| C (`clang -O3`, `scanf`) | **62.8 ± 3.2 ms** |
