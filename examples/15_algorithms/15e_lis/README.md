...
| path | wall |
|---|---:|
| plain CPython | 557.4 ± 13.5 ms |
| `ppy run` | 207.3 ± 156.6 ms |
| `ppy build --unsafe` | 120.0 ± 1.4 ms |
| `ppy build --standalone --unsafe` | **42.4 ± 0.5 ms** |
| C (`gcc -O3`, `scanf`) | 60.1 ± 0.5 ms |
| C (`clang -O3`, `scanf`) | 56.8 ± 0.8 ms |
