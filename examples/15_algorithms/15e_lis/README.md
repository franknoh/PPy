...
| path | wall |
|---|---:|
| plain CPython | 568.1 ± 14.7 ms |
| `ppy run` | 209.2 ± 159.6 ms |
| `ppy build --unsafe` | 117.5 ± 3.5 ms |
| `ppy build --standalone --unsafe` | **43.8 ± 2.0 ms** |
| C (`gcc -O3`, `scanf`) | 60.2 ± 1.0 ms |
| C (`clang -O3`, `scanf`) | 58.5 ± 2.7 ms |
