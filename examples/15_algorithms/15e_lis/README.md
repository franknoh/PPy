...
| path | wall |
|---|---:|
| plain CPython | 527.5 ± 9.5 ms |
| `ppy run` | 194.3 ± 151.9 ms |
| `ppy build --unsafe` | 109.6 ± 1.1 ms |
| `ppy build --standalone --unsafe` | **40.2 ± 0.4 ms** |
| C (`gcc -O3`, `scanf`) | 57.3 ± 1.2 ms |
| C (`clang -O3`, `scanf`) | 55.6 ± 1.5 ms |
