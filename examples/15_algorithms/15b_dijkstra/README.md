...
| path | wall |
|---|---:|
| plain CPython | 4862.2 ± 38.3 ms |
| `ppy run` | 3605.1 ± 253.4 ms |
| `ppy build --unsafe` | 4427.9 ± 41.4 ms |
| `ppy build --standalone --unsafe` | **110.2 ± 2.3 ms** |
| C (`gcc -O3`, `scanf`) | 137.1 ± 1.7 ms |
| C (`clang -O3`, `scanf`) | 130.4 ± 1.6 ms |
