...
| path | wall |
|---|---:|
| plain CPython | 5212.8 ± 88.8 ms |
| `ppy run` | 3909.9 ± 253.7 ms |
| `ppy build --unsafe` | 4773.4 ± 22.6 ms |
| `ppy build --standalone --unsafe` | **122.2 ± 1.5 ms** |
| C (`gcc -O3`, `scanf`) | 158.6 ± 10.7 ms |
| C (`clang -O3`, `scanf`) | 146.1 ± 2.0 ms |
