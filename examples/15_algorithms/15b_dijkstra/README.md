...
| path | wall |
|---|---:|
| plain CPython | 5171.3 ± 83.2 ms |
| `ppy run` | 3849.8 ± 253.4 ms |
| `ppy build --unsafe` | 4790.7 ± 180.9 ms |
| `ppy build --standalone --unsafe` | **114.5 ± 2.0 ms** |
| C (`gcc -O3`, `scanf`) | 148.8 ± 4.9 ms |
| C (`clang -O3`, `scanf`) | 140.2 ± 1.7 ms |
