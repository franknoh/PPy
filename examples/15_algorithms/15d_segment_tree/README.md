...
| path | wall |
|---|---:|
| plain CPython | 1578.5 ± 43.3 ms |
| `ppy run` | 1315.3 ± 189.4 ms |
| `ppy build --unsafe` | 1525.9 ± 14.9 ms |
| `ppy build --standalone --unsafe` | **29.6 ± 0.8 ms** |
| C (`gcc -O3`, `scanf`) | 50.5 ± 0.2 ms |
| C (`clang -O3`, `scanf`) | 50.9 ± 1.7 ms |
