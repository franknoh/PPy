...
| path | wall |
|---|---:|
| plain CPython | 1834.3 ± 238.9 ms |
| `ppy run` | 1468.8 ± 386.0 ms |
| `ppy build --unsafe` | 1871.5 ± 269.9 ms |
| `ppy build --standalone --unsafe` | **50.6 ± 19.8 ms** |
| C (`gcc -O3`, `scanf`) | 65.0 ± 6.4 ms |
| C (`clang -O3`, `scanf`) | 56.4 ± 4.8 ms |
