...
| path | wall |
|---|---:|
| plain CPython | 1658.5 ± 23.2 ms |
| `ppy run` | 1360.1 ± 196.7 ms |
| `ppy build --unsafe` | 1589.0 ± 28.2 ms |
| `ppy build --standalone --unsafe` | **32.0 ± 0.6 ms** |
| C (`gcc -O3`, `scanf`) | 53.6 ± 1.7 ms |
| C (`clang -O3`, `scanf`) | 52.9 ± 1.0 ms |
