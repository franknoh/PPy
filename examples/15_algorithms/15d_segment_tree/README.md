...
| path | wall |
|---|---:|
| plain CPython | 999.5 ± 17.5 ms |
| `ppy run` | 690.6 ± 182.1 ms |
| `ppy build --unsafe` | 738.6 ± 15.1 ms |
| `ppy build --standalone --unsafe` | **28.7 ± 0.4 ms** |
| C (`gcc -O3`, `scanf`) | 51.3 ± 1.8 ms |
| C (`clang -O3`, `scanf`) | 49.2 ± 0.4 ms |
