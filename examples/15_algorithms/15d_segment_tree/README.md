...
| path | wall |
|---|---:|
| plain CPython | 1568.3 ± 3.1 ms |
| `ppy run` | 1280.8 ± 186.5 ms |
| `ppy build --unsafe` | 1498.3 ± 19.9 ms |
| `ppy build --standalone --unsafe` | **28.5 ± 0.5 ms** |
| C (`gcc -O3`, `scanf`) | 49.1 ± 0.7 ms |
| C (`clang -O3`, `scanf`) | 49.2 ± 1.2 ms |
