...
| path | wall |
|---|---:|
| plain CPython | 1022.3 ± 10.4 ms |
| `ppy run` | 718.6 ± 185.5 ms |
| `ppy build --unsafe` | 753.2 ± 5.8 ms |
| `ppy build --standalone --unsafe` | **30.7 ± 1.1 ms** |
| C (`gcc -O3`, `scanf`) | 51.9 ± 0.8 ms |
| C (`clang -O3`, `scanf`) | 50.9 ± 0.7 ms |
