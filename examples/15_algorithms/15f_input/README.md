...
| path | wall |
|---|---:|
| plain CPython | 660.2 ± 74.1 ms |
| `ppy run` | 189.4 ± 165.2 ms |
| `ppy build --unsafe` | 91.5 ± 2.8 ms |
| `ppy build --standalone --unsafe` | **41.4 ± 0.4 ms** |
| C (`gcc -O3`, `scanf`) | 46.4 ± 1.1 ms |
| C (`clang -O3`, `scanf`) | 45.7 ± 0.7 ms |
