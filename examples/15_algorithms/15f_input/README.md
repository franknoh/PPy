...
| path | wall |
|---|---:|
| plain CPython | 612.3 ± 13.1 ms |
| `ppy run` | 186.4 ± 162.7 ms |
| `ppy build --unsafe` | 96.3 ± 1.8 ms |
| `ppy build --standalone --unsafe` | **40.5 ± 0.6 ms** |
| C (`gcc -O3`, `scanf`) | 47.3 ± 0.4 ms |
| C (`clang -O3`, `scanf`) | 46.9 ± 1.1 ms |
