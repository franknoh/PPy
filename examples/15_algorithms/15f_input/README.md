...
| path | wall |
|---|---:|
| plain CPython | 600.2 ± 20.3 ms |
| `ppy run` | 190.3 ± 171.2 ms |
| `ppy build --unsafe` | 97.7 ± 0.9 ms |
| `ppy build --standalone --unsafe` | **39.4 ± 1.0 ms** |
| C (`gcc -O3`, `scanf`) | 44.9 ± 1.8 ms |
| C (`clang -O3`, `scanf`) | 46.1 ± 1.2 ms |
