...
| path | wall |
|---|---:|
| plain CPython | 631.6 ± 21.1 ms |
| `ppy run` | 202.1 ± 174.8 ms |
| `ppy build --unsafe` | 106.2 ± 3.3 ms |
| `ppy build --standalone --unsafe` | **42.9 ± 1.2 ms** |
| C (`gcc -O3`, `scanf`) | 48.7 ± 1.2 ms |
| C (`clang -O3`, `scanf`) | 48.0 ± 0.4 ms |
