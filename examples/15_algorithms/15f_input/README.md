...
| path | wall |
|---|---:|
| plain CPython | 614.2 ± 18.2 ms |
| `ppy run` | 186.8 ± 158.4 ms |
| `ppy build --unsafe` | 99.4 ± 2.2 ms |
| `ppy build --standalone --unsafe` | **38.5 ± 0.7 ms** |
| C (`gcc -O3`, `scanf`) | 44.5 ± 0.5 ms |
| C (`clang -O3`, `scanf`) | 45.0 ± 1.4 ms |
